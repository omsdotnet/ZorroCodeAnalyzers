...
namespace ZorroCodeAnalyzers
{
  ...
  public class ZA0002DomainIntersector : DiagnosticAnalyzer
  {
    public const string DiagnosticId = "ZA0002";
    private const string Category = "Architecture";
    private const string KeyWord = "Domain";

    private static readonly string[] rejectedKeyWord = { "Application", "Infrastructure" };

    private static readonly LocalizableString title = new LocalizableResourceString(nameof(Resources.ZA0002Title), Resources.ResourceManager, typeof(Resources));
    private static readonly LocalizableString messageFormat = new LocalizableResourceString(nameof(Resources.ZA0002MessageFormat), Resources.ResourceManager, typeof(Resources));
    private static readonly LocalizableString description = new LocalizableResourceString(nameof(Resources.ZA0002Description), Resources.ResourceManager, typeof(Resources));
